    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 text-md-end">
            ...
            <?php if ($_SERVER["REQUEST_METHOD"] == "POST"): ?>
                <a class="btn btn-danger me-2 mb-2" href="index.php?pdf=<?php echo $_POST['usuarios']; ?>">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="input-group mb-3">
                <input type="text" class="form-control" maxlength="50" name="usuarios"
                    placeholder="Pesquisar usuários..." required>
            ...
            <?php if ($usuarios): ?>
                <?php foreach ($usuarios as $usuario): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="view.php?id=<?php echo htmlspecialchars($usuario['id']); ?>" class="btn btn-sm btn-dark">
                            ...
                            <a href="#" class="btn btn-sm btn-light" data-bs-toggle="modal"
                                ...
                                data-usuario="<?php echo htmlspecialchars($usuario['id']); ?>">
...
$totalRegistros = count(find_all("usuarios"));
